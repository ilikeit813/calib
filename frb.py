...
def guplot(timeL,timeH,SNRmin,DML,DMH,resolL,resolH):
    ...
    cur = con.cursor()
    cur.execute("SELECT snr, dm, time_tag FROM 'lwa1' WHERE (time_tag> '%.3f' and time_tag< '%.3f' and snr > '%.3f' and dm > '%.4f' and dm < '%.4f' and resolution > '%.4f' and resolution < '%.4f' and time_tag NOT BETWEEN 3150 and 3200 and time_tag NOT BETWEEN 3700 and 3900 and time_tag NOT BETWEEN 6000 and 6100)" %(timeL, timeH, SNRmin, DML, DMH, resolL, resolH) )
...
#guplot(timeL,timeH,SNRmin,DML,DMH,resolL,resolH):
guplot(0,14400,5.5,0,3500,0,10)